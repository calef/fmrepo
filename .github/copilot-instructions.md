...
- Ruby and Bundler are required (`.ruby-version`, `.bundler-version`, `.ruby-gemset`). Run `./script/bootstrap` to install via mise + bundler and to clear any `bundle config without` settings.
