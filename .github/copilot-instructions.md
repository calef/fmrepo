...
## Setup & Environment
- Ruby 3.4.8 and Bundler 4.0.3 are required (`.ruby-version`, `.bundler-version`, `.ruby-gemset`). Run `./script/bootstrap` to install via mise + bundler and to clear any `bundle config without` settings.
